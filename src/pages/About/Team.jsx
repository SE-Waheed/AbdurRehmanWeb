...
function Team() {
  return (
    ...
    <div className="max-w-5xl max-sm:max-w-sm mx-auto">
        <h2 className="text-gray-800 text-4xl font-extrabold text-center">Meet Our Team</h2>
        ...
        <div className="grid lg:grid-cols-4 md:grid-cols-3 sm:grid-cols-2 gap-8 text-center mt-12">
            <div className="bg-white py-4 px-2 shadow-md rounded-lg hover:scale-110 transition-all duration-500">
                <img src="https://readymadeui.com/team-1.webp" className="w-36 h-36 rounded-full inline-block" />
            ...
            <div className="bg-white py-4 px-2 shadow-md rounded-lg hover:scale-110 transition-all duration-500">
                <img src="https://readymadeui.com/team-2.webp" className="w-36 h-36 rounded-full inline-block" />
            ...
            <div className="bg-white py-4 px-2 shadow-md rounded-lg hover:scale-110 transition-all duration-500">
                <img src="https://readymadeui.com/team-3.webp" className="w-36 h-36 rounded-full inline-block" />
            ...
            <div className="bg-white py-4 px-2 shadow-md rounded-lg hover:scale-110 transition-all duration-500">
                <img src="https://readymadeui.com/team-4.webp" className="w-36 h-36 rounded-full inline-block" />
            ...
            <div className="bg-white py-4 px-2 shadow-md rounded-lg hover:scale-110 transition-all duration-500">
                <img src="https://readymadeui.com/team-5.webp" className="w-36 h-36 rounded-full inline-block" />
            ...
            <div className="bg-white py-4 px-2 shadow-md rounded-lg hover:scale-110 transition-all duration-500">
                <img src="https://readymadeui.com/team-6.webp" className="w-36 h-36 rounded-full inline-block" />
