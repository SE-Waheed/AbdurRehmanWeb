...
// const {isAuth,setIsAuth}=useAuthContext()
  const [state, setState] = useState({name:'',email:'',password:'',role:''})
...
const handleSubmit=(e)=>{
  ...
  createUserWithEmailAndPassword(firebaseAuth, email, password) .then((userCredential) => {   
    const fireData=userCredential.user
    // console.log(user)
createProfile(fireData)
  ...
  // navigate('/Auth/Login')
  const createProfile=async(fireData)=>{
    const userData={
      name:name,
    ...
    try{
      await setDoc(doc(db, "user", fireData.uid), userData);
      ...
      <div className="w-full max-w-4xl max-md:max-w-xl mx-auto">
        <div className="bg-white grid md:grid-cols-2 gap-16 w-full sm:p-8 p-6 shadow-md rounded-md overflow-hidden">
          ...
          <form onSubmit={handleSubmit} className="w-full">
            ...
            <div className="space-y-6">
              <div>
                ...
                <div className="relative flex items-center">
                  <input onChange={handleChange} name="name" type="text" required className="bg-white border border-gray-300 w-full text-sm text-gray-800 pl-4 pr-10 py-2.5 rounded-md outline-blue-500" placeholder="Enter name" />
              ...
              <div>
                ...
                <div className="relative flex items-center">
                  <input onChange={handleChange} name="email" type="email" required className="bg-white border border-gray-300 w-full text-sm text-gray-800 pl-4 pr-10 py-2.5 rounded-md outline-blue-500" placeholder="Enter email" />
              ...
              <div>
                ...
                <div className="relative flex items-center">
                  <input onChange={handleChange} name="password" type="password" required className="bg-white border border-gray-300 w-full text-sm text-gray-800 pl-4 pr-10 py-2.5 rounded-md outline-blue-500" placeholder="Enter password" />
            ...
            <p className="text-gray-800 text-sm mt-6 text-center">Already have an account? <NavLink to="/Auth/Login" className="text-blue-600 font-semibold hover:underline ml-1">Login here</NavLink></p>
          </form>
        </div>
      </div>
    </div>
